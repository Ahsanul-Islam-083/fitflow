      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="text-[10px] md:text-xs font-bold text-blue-600 uppercase tracking-[0.2em]">Training Sessions</span>
          ...
          <p className="text-muted-foreground mt-6 max-w-2xl text-sm md:text-base leading-relaxed">
            Explore our curated selection of high-intensity programs designed by expert coaches to push your limits and accelerate your results.
          </p>
        </motion.div>
        ...
        >
          <Button asChild className="bg-blue-600 text-white hover:bg-blue-700 h-12 md:h-14 px-8 md:px-10 uppercase tracking-[0.2em] text-[10px] md:text-xs font-bold rounded-md transition-all shadow-lg shadow-blue-600/20">
            <Link href="/classes">
