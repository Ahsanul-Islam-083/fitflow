      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="text-[10px] md:text-xs font-bold text-blue-600 uppercase tracking-[0.2em]">Community Hub</span>
          ...
          <p className="text-muted-foreground mt-6 max-w-2xl text-sm md:text-base leading-relaxed">
            Dive into conversations with trainers and members, explore fitness tips, and stay motivated with fresh content every week.
          </p>
        </motion.div>
