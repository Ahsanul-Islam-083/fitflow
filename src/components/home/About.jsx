        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <motion.div variants={itemVariants} className="flex items-center gap-4">
              <span className="text-[11px] md:text-xs font-bold text-blue-600 uppercase tracking-[0.2em]">More About Us</span>
            ...
            <motion.blockquote variants={itemVariants} className="border-l-4 border-blue-600 pl-5 py-2 italic font-semibold text-foreground/80 leading-relaxed">
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-start sm:items-center gap-6 sm:gap-10 pt-6">
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center justify-center size-12 rounded-full bg-blue-100 dark:bg-blue-900/20 text-blue-600">
              ...
              <Button asChild className="bg-blue-600 text-white hover:bg-blue-700 h-12 md:h-14 px-8 uppercase tracking-[0.15em] text-[11px] font-bold rounded-md transition-all">
                <Link href="/about">
                  Learn More About Us
                </Link>
              </Button>
          ...
          <div className="relative w-full h-[500px] sm:h-[600px] lg:h-[700px] mt-12 lg:mt-0 flex justify-center lg:justify-start">
            ...
            <motion.div 
              ...
              className="absolute bottom-[5%] lg:bottom-[10%] right-[5%] sm:right-[10%] bg-blue-600 text-white px-6 sm:px-8 py-5 sm:py-6 rounded-xl shadow-2xl flex items-center gap-4 z-10"
            >
