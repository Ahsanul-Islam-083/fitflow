      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="text-[10px] md:text-xs font-bold text-blue-600 uppercase tracking-[0.2em]">Our Trainer</span>
            <div className="h-[2px] w-8 md:w-12 bg-blue-600" />
          </div>
              ...
              >
                ...
                <Card className="relative w-full h-full bg-gradient-to-br from-slate-700 via-slate-800 to-slate-950 dark:from-slate-800 dark:via-slate-900 dark:to-black overflow-hidden shadow-2xl shadow-black/40 border border-border/50">
                  <CardContent className="p-0 h-full">
                    ...
                    <div className="absolute bottom-6 left-6 right-6 bg-blue-600 py-5 px-4 text-center transform transition-all duration-500 shadow-xl shadow-blue-600/20 z-50 rounded-lg md:rounded-xl">
          ...
          {trainers.length > 1 && (
            <div className="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 w-[340px] sm:w-[440px] md:w-[560px] lg:w-[600px] h-0 flex items-center justify-between px-0 z-50 pointer-events-none">
              <Button 
                ...
                size="icon"
                onClick={handlePrev}
                className="pointer-events-auto bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-xl transition-transform hover:scale-110 flex items-center justify-center w-12 h-12 md:w-14 md:h-14"
              >
