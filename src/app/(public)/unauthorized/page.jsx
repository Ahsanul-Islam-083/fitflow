    ...
    <main className="flex-1 flex flex-col items-center justify-center bg-background p-6 py-12 md:py-24">
      ...
      >
        ...
        <motion.div 
          ...
          className="relative flex size-32 md:size-48 items-center justify-center rounded-full bg-blue-600/10 shadow-[0_0_40px_rgba(37,99,235,0.2)]"
        >
          <ShieldAlert className="size-16 md:size-24 text-blue-600 drop-shadow-xl" />
        </motion.div>
        ...
        >
          <Button asChild className="bg-blue-600 hover:bg-blue-700 text-white rounded-xl h-14 px-8 text-lg font-bold shadow-lg shadow-blue-600/20 transition-all hover:-translate-y-1">
            <Link href="/dashboard">
