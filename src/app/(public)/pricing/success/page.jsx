    ...
    return (
      <main className="min-h-screen bg-background pt-32 pb-16 flex items-center justify-center px-4">
        <div className="max-w-xl w-full text-center space-y-8 flex flex-col items-center animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="relative flex size-24 items-center justify-center rounded-full bg-blue-600/10 shadow-[0_0_40px_rgba(37,99,235,0.2)]">
            <XCircle className="size-12 text-blue-600 drop-shadow-md" />
          </div>
          ...
          <Button asChild className="bg-blue-600 hover:bg-blue-700 text-white rounded-xl h-14 px-8 text-lg font-bold shadow-lg shadow-blue-600/20 transition-all hover:-translate-y-1 mt-4">
      ...
      return (
        <main className="min-h-screen bg-background pt-32 pb-16 flex items-center justify-center px-4">
          <div className="max-w-2xl w-full text-center space-y-8 flex flex-col items-center animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="relative flex size-32 items-center justify-center rounded-full bg-blue-600/10 shadow-[0_0_40px_rgba(37,99,235,0.2)]">
              <CheckCircle2 className="size-16 text-blue-600 drop-shadow-md" />
            </div>
            ...
            <div className="pt-6 w-full max-w-sm flex flex-col gap-4">
              <Button asChild className="bg-blue-600 hover:bg-blue-700 text-white rounded-xl h-14 px-8 text-lg font-bold shadow-lg shadow-blue-600/20 transition-all hover:-translate-y-1 w-full">
