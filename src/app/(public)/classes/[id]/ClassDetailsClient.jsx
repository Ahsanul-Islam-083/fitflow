    ...
    <main className="min-h-screen bg-background pb-32 lg:pb-24 pt-0 lg:pt-24">
      ...
      >
        ...
        <div className="absolute bottom-6 left-4 right-4 z-20 space-y-2">
          <Badge className="bg-blue-600 text-white border-0 px-2.5 py-0.5 uppercase tracking-widest text-[10px] font-bold">
            {cls.category}
          </Badge>
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          ...
          <div className="space-y-4">
            <Badge className="bg-blue-600/10 text-blue-600 border-blue-600/20 px-3 py-1 uppercase tracking-widest text-[10px] font-bold hover:bg-blue-600/20">
              {cls.category}
            </Badge>
        ...
        >
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            >
              <motion.div variants={{ hidden: { opacity: 0, y: 10 }, show: { opacity: 1, y: 0 } }} className="flex items-center gap-4 p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900/50 border-0 shadow-sm">
                <div className="size-10 rounded-lg bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center shrink-0">
                  <Clock className="size-5 text-blue-600 dark:text-blue-400" />
                </div>
                <div>
                  <p className="text-[9px] lg:text-[10px] font-bold uppercase tracking-widest text-zinc-400 dark:text-zinc-500">Duration</p>
                  <p className="text-sm lg:text-base font-bold text-zinc-800 dark:text-zinc-200 leading-tight mt-0.5">{cls.duration} mins</p>
                </div>
              </motion.div>
              <motion.div variants={{ hidden: { opacity: 0, y: 10 }, show: { opacity: 1, y: 0 } }} className="flex items-center gap-4 p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900/50 border-0 shadow-sm">
                <div className="size-10 rounded-lg bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center shrink-0">
                ...
                <div>
                  <p className="text-[9px] lg:text-[10px] font-bold uppercase tracking-widest text-zinc-400 dark:text-zinc-500">Level</p>
                  <p className="text-sm lg:text-base font-bold text-zinc-800 dark:text-zinc-200 leading-tight mt-0.5">{cls.difficulty}</p>
                </div>
              </motion.div>
              <motion.div variants={{ hidden: { opacity: 0, y: 10 }, show: { opacity: 1, y: 0 } }} className="flex items-center gap-4 p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900/50 border-0 shadow-sm">
                <div className="size-10 rounded-lg bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center shrink-0">
                ...
                <div>
                  <p className="text-[9px] lg:text-[10px] font-bold uppercase tracking-widest text-zinc-400 dark:text-zinc-500">Focus</p>
                  <p className="text-sm lg:text-base font-bold text-zinc-800 dark:text-zinc-200 leading-tight mt-0.5">{cls.focus || "Full Body"}</p>
                </div>
              </motion.div>
              <motion.div variants={{ hidden: { opacity: 0, y: 10 }, show: { opacity: 1, y: 0 } }} className="flex items-center gap-4 p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900/50 border-0 shadow-sm">
                ...
                <div>
                  <p className="text-[9px] lg:text-[10px] font-bold uppercase tracking-widest text-zinc-400 dark:text-zinc-500">Est. Burn</p>
                  <p className="text-sm lg:text-base font-bold text-zinc-800 dark:text-zinc-200 leading-tight mt-0.5">{cls.estBurn ? `${cls.estBurn} kcal` : "Varies"}</p>
                </div>
              </motion.div>
              <motion.div variants={{ hidden: { opacity: 0, y: 10 }, show: { opacity: 1, y: 0 } }} className="flex items-center gap-4 p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900/50 border-0 shadow-sm">
                <div className="size-10 rounded-lg bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center shrink-0">
                  <CalendarClock className="size-5 text-purple-500 dark:text-purple-400" />
                </div>
                <div>
                  <p className="text-[9px] lg:text-[10px] font-bold uppercase tracking-widest text-zinc-400 dark:text-zinc-500">Schedule</p>
                  <p className="text-sm lg:text-base font-bold text-zinc-800 dark:text-zinc-200 leading-tight mt-0.5">{cls.scheduleDays ? cls.scheduleDays.join(", ") : "Various"}</p>
                </div>
              </motion.div>
              <motion.div variants={{ hidden: { opacity: 0, y: 10 }, show: { opacity: 1, y: 0 } }} className="flex items-center gap-4 p-4 rounded-xl bg-zinc-50 dark:bg-zinc-900/50 border-0 shadow-sm">
                ...
                <div>
                  <p className="text-[9px] lg:text-[10px] font-bold uppercase tracking-widest text-zinc-400 dark:text-zinc-500">Status</p>
                  <p className="text-sm lg:text-base font-bold text-emerald-600 dark:text-emerald-400 leading-tight mt-0.5">Open</p>
                </div>
              </motion.div>
            </motion.div>
            ...
            <div className="space-y-10">
              <div className="space-y-4">
                ...
                <div className="text-zinc-600 dark:text-zinc-400 leading-relaxed text-sm lg:text-base whitespace-pre-line bg-zinc-50 dark:bg-zinc-900/30 p-5 rounded-2xl border-0 shadow-sm">
                  {cls.description}
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4 p-4 lg:p-6 rounded-2xl bg-zinc-50 dark:bg-zinc-900/30 border-0 shadow-sm">
                  {cls.trainerImage ? (
                    // eslint-disable-next-line @next/next/no-img-element
                    ...
                    <div className="size-16 lg:size-20 rounded-full bg-blue-600/10 flex items-center justify-center border-2 border-background shadow-sm shrink-0">
                      <Dumbbell className="size-6 lg:size-8 text-blue-600" />
                    </div>
                  )}
                  <div className="space-y-1">
                    <p className="text-[9px] lg:text-[10px] font-bold tracking-widest uppercase text-blue-600 bg-blue-600/10 inline-block px-2 lg:px-3 py-0.5 lg:py-1 rounded-md">Lead Coach</p>
                    <h3 className="text-lg lg:text-xl font-black uppercase text-foreground">{cls.trainerName || "Expert Trainer"}</h3>
                    <p className="text-xs lg:text-sm text-zinc-500 dark:text-zinc-400 line-clamp-2">
          ...
          <div className="hidden lg:block lg:col-span-1">
            <div className="sticky top-24">
              ...
              <div className="border-0 shadow-[0_4px_20px_rgba(0,0,0,0.06)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.2)] rounded-2xl bg-zinc-50 dark:bg-zinc-900/50 overflow-hidden">
                <div className="p-6 md:p-8 flex flex-col">
                  
                  {/* Price Header */}
                  <div className="flex flex-col items-center justify-center text-center pb-8 border-b border-border">
                  <Badge className="mb-4 text-[10px] font-bold tracking-widest uppercase bg-blue-600 text-white border-0 px-3 py-1 rounded-md shadow-sm">Class Pass</Badge>
                  <div className="flex items-start justify-center text-zinc-800 dark:text-zinc-100">
                  ...
                  <p className="text-xs font-medium text-zinc-400 dark:text-zinc-500 mt-2 uppercase tracking-widest">One-time payment</p>
                  </div>

                  {/* Logistics List */}
                  <div className="py-8 space-y-6">
                    <div className="flex items-start gap-4">
                      <div className="p-2 rounded-md bg-blue-600/10 text-blue-600 shrink-0 mt-0.5">
                        <CalendarClock className="size-4" />
                      </div>
                      <div className="space-y-1">
                      <p className="text-xs font-bold uppercase tracking-widest text-zinc-800 dark:text-zinc-200">Schedule</p>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="space-y-1">
                      <p className="text-xs font-bold uppercase tracking-widest text-zinc-800 dark:text-zinc-200">Time</p>
                      <p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">
                          {cls.time || "TBD"}
                        </p>
                      </div>
                  ...
                  <div className="space-y-3 pt-4 border-t border-border mt-auto">
                    ...
                    >
                      <Heart className={`size-4 ${isFavorite ? "fill-blue-600 text-blue-600" : ""}`} />
              ...
              {/* Security Badge */}
                <div className="flex flex-col items-center justify-center gap-2 text-[10px] font-bold uppercase tracking-widest text-zinc-400 dark:text-zinc-500 mt-6">
      ...
      <motion.div 
        ...
        className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-white dark:bg-zinc-950 border-0 shadow-[0_-8px_30px_rgba(0,0,0,0.08)] dark:shadow-[0_-8px_30px_rgba(0,0,0,0.3)] lg:hidden"
      >
        <div className="flex items-center gap-3">
          ...
          >
            <Heart className={`size-5 ${isFavorite ? "fill-blue-600 text-blue-600" : ""}`} />
          </button>

          <form action="/api/checkout_sessions" method="POST" className="flex-1 flex items-center bg-zinc-900 dark:bg-zinc-800 text-white rounded-2xl p-1 pl-4 h-12 shadow-sm">
            <input type="hidden" name="classId" value={cls._id || params.id} />
            <input type="hidden" name="price" value={cls.price} />
            <input type="hidden" name="title" value={cls.title} />
            <input type="hidden" name="trainerId" value={cls.trainerId || ""} />
            ...
            <div className="flex flex-col mr-auto">
              <span className="text-[9px] font-bold text-white/60 uppercase tracking-widest leading-none">Total</span>
