      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-12 flex flex-col items-center">
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="text-[10px] md:text-xs font-bold text-blue-600 uppercase tracking-[0.2em]">Forum</span>
            
          </div>
          <h1 className="font-heading text-4xl sm:text-5xl lg:text-[56px] font-black uppercase tracking-tight text-foreground leading-none mb-6">Latest Conversations</h1>
          <p className="text-muted-foreground text-lg max-w-2xl text-center mb-8">Explore trending topics, share your experience, and connect with fitness enthusiasts from around the world.</p>
          
          <div className="flex flex-col sm:flex-row items-center w-full max-w-3xl bg-muted/40 rounded-xl p-1.5 gap-2 sm:gap-0 mx-auto">
        ...
        {loading ? (
          ...
          <div className="bg-blue-500/10 text-blue-500 p-6 rounded-2xl border border-blue-500/20 text-center">
            {error}
          </div>
        ) : posts.length === 0 ? (
              ...
              <div className="flex items-center justify-center gap-2 pt-8 border-t border-border/50">
                ...
                {[...Array(totalPages)].map((_, i) => (
                  <Button 
                    ...
                    className={`size-10 rounded-md font-bold ${currentPage === i + 1 ? "bg-blue-600 hover:bg-blue-700 text-white shadow-md" : "border-border bg-background hover:bg-muted"}`}
                  >
                    {i + 1}
                  </Button>
                ))}
