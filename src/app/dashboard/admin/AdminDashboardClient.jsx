      ...
      <motion.section variants={itemVariants} className="grid gap-4 lg:grid-cols-3">
        ...
        <article className="min-w-0 rounded-2xl border bg-card p-6 shadow-sm flex flex-col max-h-[400px] lg:h-[400px]">
          <div className="flex items-center justify-between mb-4 shrink-0">
            ...
            <Link href="/dashboard/admin/trainers" className="text-[10px] font-bold uppercase tracking-wider text-blue-600 hover:text-blue-700 transition-colors">View All</Link>
          </div>
        ...
        <article className="min-w-0 rounded-2xl border bg-card p-6 shadow-sm flex flex-col max-h-[400px] lg:h-[400px]">
          <div className="flex items-center justify-between mb-4 shrink-0">
            ...
            <Link href="/dashboard/admin/classes" className="text-[10px] font-bold uppercase tracking-wider text-blue-600 hover:text-blue-700 transition-colors">View All</Link>
          </div>
          <div className="flex-1 overflow-y-auto pr-2 space-y-3 custom-scrollbar">
        ...
        <article className="min-w-0 rounded-2xl border bg-card p-6 shadow-sm flex flex-col max-h-[400px] lg:h-[400px]">
          <div className="flex items-center justify-between mb-4 shrink-0">
            ...
            <Link href="/dashboard/admin/transactions" className="text-[10px] font-bold uppercase tracking-wider text-blue-600 hover:text-blue-700 transition-colors">View All</Link>
          </div>
          <div className="flex-1 overflow-y-auto pr-2 space-y-3 custom-scrollbar">
