                  ...
                  <TableCell className="px-6 py-4">
                    <div className="flex items-center gap-1.5">
                      {!user.isBlocked ? (
                        ...
                        <span className="inline-flex items-center gap-1.5 rounded-md bg-blue-500/10 px-2 py-1 text-[10px] font-bold text-blue-600 uppercase tracking-widest">
                      ...
                      {userId !== SUPER_ADMIN_ID && (
                        user.isBlocked ? (
                          ...
                          <Button 
                            ...
                            className="h-8 gap-1.5 px-3 text-[11px] font-bold text-blue-600 bg-blue-50 hover:bg-blue-100 dark:bg-blue-900/30 dark:text-blue-400 dark:hover:bg-blue-900/50 transition-all border border-blue-200 dark:border-blue-900"
                          >
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <Button 
                  ...
                  className={`rounded-xl px-6 h-11 text-white font-bold transition-all hover:scale-105 active:scale-95 disabled:hover:scale-100 ${
                    modalState.type === "block" ? "bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 shadow-lg shadow-blue-600/20 dark:shadow-none" :
                    ...
                    modalState.type === "promote" ? "bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 shadow-lg shadow-blue-600/20 dark:shadow-none" :
