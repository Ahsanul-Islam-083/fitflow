    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 relative">
      ...
      <section className="flex flex-wrap gap-2 p-1.5 bg-muted/30 border border-border/50 rounded-xl w-fit">
        ...
        <button
          ...
          className={`px-4 py-2 text-sm font-bold transition-all rounded-lg ${
            activeTab === "Rejected" ? "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400 ring-1 ring-blue-200 dark:ring-blue-900 shadow-sm" : "text-muted-foreground hover:text-foreground hover:bg-muted/50"
          }`}
        >
          Rejected Logs
        </button>
                    ...
                    <div className="flex items-center gap-3">
                      <Avatar className={`size-10 rounded-xl transition-transform group-hover:scale-105 `}>
                        ...
                        <AvatarFallback className={`rounded-xl font-bold ${
                          ...
                          status === "approved" ? "bg-emerald-500/10 text-emerald-600" : "bg-blue-500/10 text-blue-600"
                        }`}>
                    ...
                    {status === "pending" ? (
                      ...
                      <div className="flex justify-end gap-2">
                        ...
                        <Button 
                          ...
                          className="bg-blue-500/10 text-blue-600 hover:bg-blue-500 hover:text-white"
                        >
            ...
            <CardContent>
              ...
              {selectedTrainer.status === "pending" ? (
                ...
                <div className="mt-6 rounded-2xl border border-blue-500/20 bg-blue-500/5 p-4">
                  <h4 className="text-xs font-bold uppercase tracking-wider text-blue-600 mb-1">Feedback Provided</h4>
