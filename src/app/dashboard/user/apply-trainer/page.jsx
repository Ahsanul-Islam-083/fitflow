      ...
      {isSubmitted || hasExistingApp || session?.user?.trainerApplicationStatus === "pending" ? (
        <Card className="flex flex-col items-center justify-center border-border bg-card p-12 text-center shadow-xl">
          ...
          <CardDescription className="mt-4 text-lg">
            Thank you for applying. Your application is now marked as <span className="font-bold text-blue-600">Pending</span>. Our admins will review your profile shortly.
          </CardDescription>
        </Card>
      ) : rejectedApp && !isReapplying ? (
        <Card className="border-border bg-card shadow-xl overflow-hidden relative">
          <CardHeader className="text-center pb-2 relative z-10">
            <div className="mx-auto flex size-16 items-center justify-center rounded-full bg-blue-600/10 text-blue-600 mb-4 shadow-sm">
          ...
          <CardFooter className="flex justify-center mt-6 pb-10 relative z-10">
            <Button 
              ...
              size="lg"
              className="rounded-xl gap-2 bg-blue-600 text-white hover:bg-blue-700 font-bold transition-all hover:-translate-y-1"
            >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-6">
                <Button 
                  type="submit"
                  disabled={isPending}
                  className="w-full h-14 px-8 gap-2 rounded-xl bg-blue-600 text-white text-lg font-bold shadow-lg shadow-blue-600/20 hover:bg-blue-700 hover:-translate-y-1 active:scale-95 transition-all"
                >
