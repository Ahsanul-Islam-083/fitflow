      ...
      {favoriteClasses.length > 0 ? (
        ...
        >
          <motion.div 
            ...
            className="relative flex size-24 items-center justify-center rounded-full bg-blue-600/10 mb-6 shadow-[0_0_40px_rgba(37,99,235,0.2)]"
          >
            <HeartOff className="size-12 text-blue-600 drop-shadow-md" />
          </motion.div>
          ...
          >
            <Link 
              href="/classes"
              className="mt-8 inline-flex items-center justify-center rounded-xl bg-blue-600 px-8 py-4 text-lg font-bold text-white shadow-lg shadow-blue-600/20 hover:bg-blue-700 hover:-translate-y-1 transition-all"
            >
              Browse Classes
            </Link>
          </motion.div>
